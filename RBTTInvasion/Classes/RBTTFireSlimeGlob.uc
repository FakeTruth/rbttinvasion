...
simulated function SplashGloblings()
{
	...
	if ( (GlobStrength > MaxRestingGlobStrength) && (UTPawn(Base) == None) )
	{
		if (Role == ROLE_Authority)
		{
			...
			{
				NewGlob = Spawn(Class'RBTTFireSlimeGlobling', self,, Location+GlobVolume*6*SurfaceNormal);
				if (NewGlob != None)
				{
					// init newglob
...
defaultproperties
{
	...
	Begin Object Name=HitWallFX
		Template=ParticleSystem'RBTTSlime.Particles.Fire_Bio_Impact_Primary_Wall'
		bAutoActivate=false
