...
class RBTTBioMartian2k4FamilyInfo extends UTFamilyInfo
	abstract;
...
defaultproperties
{
   ...
   FamilyID="BioMartian"
   Faction="RBTTMonster"
   PhysAsset=PhysicsAsset'Martian2k4.MartianMeshGreenMartianHeadSkeleton_Physics'
   MasterSkeleton=SkeletalMesh'Martian2k4.MartianMeshGreenMartianHeadSkeleton'

   DeathMeshSkelMesh=SkeletalMesh'Martian2k4.MartianMeshGreenMartianHeadSkeleton'
   DeathMeshPhysAsset=PhysicsAsset'Martian2k4.MartianMeshGreenMartianHeadSkeleton_Physics'
   ...
   Name="Default__RBTTBioMartian2k4FamilyInfo"
